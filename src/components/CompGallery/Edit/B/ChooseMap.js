 ...
 const ChooseMap = ({
  ...
  , addDeleteNotification
    ...
    const onClick_Map = (event, set, idMap) => {
      ...
      if (set === "all"){
        replaceData2CompGallery("edit", "listIdMap", listIdAllMap);
      }
      else if (set === "2lines"){
        replaceData2CompGallery("edit", "listIdMap", listId2LineMap);
      }
      else if (set === "3lines"){
        replaceData2CompGallery("edit", "listIdMap", listId3LineMap);
      }
        ...
        if (whichAdding === "Map" && !(listIdMap.includes(idMap)) ) {
          ...
          replaceData2CompGallery("edit", "listIdMap", listIdMapTemp);
          
          replaceData2CompGallery("edit", "triggerPosition", Date.now().toString());
        }
