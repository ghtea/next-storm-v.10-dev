...
const DivApplyBattetag = styled(Div)`
  width: 300px;
  height:300px;
...
`
*/
const ButtonApplyBattetag = styled(Button)`
...
`
 ...
 const ApplyBattetag = ({
  ...
  const onClick_ApplyBattetag = async (event) => {
  ...
  <DivApplyBattetag>
    ...
    <ButtonApplyBattetag onClick={onClick_ApplyBattetag}> SIGN UP </ButtonApplyBattetag>
...
export default connect(mapStateToProps, mapDispatchToProps)(ApplyBattetag);